...
def proposal_id(cycle_id, proposal_id):
    ...
    newDir = "/nsls2/xf12id1/users/" + str(cycle_id) + "/" + str(proposal_id) + "/PseudoXRR"
    try:
        os.stat(newDir)
    except FileNotFoundError:
        os.makedirs(newDir)
    ...
    newDir = "/nsls2/xf12id1/users/" + str(cycle_id) + "/" + str(proposal_id) + "/PseudoXRR/gixos"
    try:
        os.stat(newDir)
    except FileNotFoundError:
        os.makedirs(newDir)
    ...
    newDir = "/nsls2/xf12id1/users/" + str(cycle_id) + "/" + str(proposal_id) + "/PseudoXRR/p100kA"
    try:
        os.stat(newDir)
    except FileNotFoundError:
        os.makedirs(newDir)
    ...
    newDir = "/nsls2/xf12id1/users/" + str(cycle_id) + "/" + str(proposal_id) + "/PseudoXRR/processed"
    try:
        os.stat(newDir)
    except FileNotFoundError:
        os.makedirs(newDir)
