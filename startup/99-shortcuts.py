...
def save_offsets():
    ...
    offset_file = open('/nsls2/data/smi/shared/xf12id1/bsui_parameters/offsets_log','a')
...
def save_positions():
    ...
    position_file = open('/nsls2/data/smi/shared/xf12id1/bsui_parameters/positions_log','a')
    e = str(datetime.datetime.now())
    if offset_counter%10 == 0:
...
def offset_read():
    motor_file1 = open('/nsls2/data/smi/shared/xf12id1/bsui_parameters/offsets_log','r')
...
def save_param():
    ...
    if old_paras == new_paras:
        ...
        old_paras = new_paras  
        parameter_file = open('/nsls2/data/smi/shared/xf12id1/bsui_parameters/geo_parameters_log','a')
