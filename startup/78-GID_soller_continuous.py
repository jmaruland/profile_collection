def gid_scan_soller_continuous(scan_dict={}, md=None, detector = pilatus100k, alphai = 0.1, beamstop = False):
    """
    Run GID scans
    ...
    def gid_method_soller_continuous(md, detector, alphai, scan_dict, beamstop = False):
        ...
        overhead_time_list       = scan_dict["overhead_time"]
  ...
  #  print(scan_dict)
   # def gid_method(md, detector, alphai, scan_dict):
    yield from gid_method_soller_continuous(md=md,
                          detector=detector,
                          alphai=alphai,
                          beamstop=beamstop,
                          scan_dict=scan_dict)
